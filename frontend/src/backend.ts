...
import type { PlanType as _PlanType, StripeSessionStatus as _StripeSessionStatus, Time as _Time, User as _User, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async adminSetUserPlan(arg0: Principal, arg1: PlanType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminSetUserPlan(arg0, to_candid_PlanType_n6(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createUser(arg0: string): Promise<User> {
        if (this.processError) {
            try {
    ...
    async deleteSavedRecipe(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteSavedRecipe(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateMealPlan(arg0: string): Promise<MealPlanner> {
        if (this.processError) {
            try {
                const result = await this.actor.generateMealPlan(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async generateRecipe(arg0: Array<string>): Promise<Recipe> {
        if (this.processError) {
            try {
                const result = await this.actor.generateRecipe(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSavedRecipes(arg0: Principal): Promise<Array<Recipe>> {
        if (this.processError) {
            try {
    ...
    async getUserMealPlans(arg0: Principal): Promise<Array<MealPlanner>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserMealPlans(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveRecipe(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveRecipe(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async upgradePlan(arg0: PlanType): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.upgradePlan(to_candid_PlanType_n6(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PlanType_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PlanType): PlanType {
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        dailyRecipeCount: value.dailyRecipeCount,
        createdAt: value.createdAt,
        email: value.email,
        dailyLimit: value.dailyLimit,
        planType: from_candid_PlanType_n4(_uploadFile, _downloadFile, value.planType)
    };
}
...
function to_candid_PlanType_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PlanType): _PlanType {
...
function to_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        email: value.email,
        dailyLimit: value.dailyLimit,
        planType: to_candid_PlanType_n6(_uploadFile, _downloadFile, value.planType)
    };
}
function to_candid_variant_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PlanType): {
    pro: null;
} | {
    premium: null;
} | {
